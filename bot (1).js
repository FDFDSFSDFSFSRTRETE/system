...
client.users.get("573517050241351691").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
client.on('message', message => {
  ...
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/p3vYjKw**")
...
const sWlc = {}
const premium = ['318705077734998017','573517050241351691']
client.on('message', message => {
var prefix = "!";
...
client.on('message', msg => {
  if (msg.content === '.') {
    msg.reply(' ★・wêlçømë to Server ★ (𝔻r)_Doctoers™ ★ :heart:  ');
  }
});
...
client.on('ready', () => {
var x = client.channels.get("588194192715415563");
if (x) x.join();
});
